...
var credentials = extend({
    ...
    username: '7b517c62-5b8a-4f19-8e35-9a70c6db92be',
    password: 'ABlXhvlFmQNr'
...
app.post('/', function(req, res) {
  ...
  personalityInsights.profile(param, function(err, profile) {
    ...
    var paragraph = showTextSummary(profile);
    
      return res.json({response:paragraph, profile: profile});
  });
});
